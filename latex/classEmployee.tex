...
default constructor for \mbox{\hyperlink{classEmployee}{Employee}}, initializes the variables ID, years, hours\+Worked, hourly\+Rate, to -\/1 
...
That \mbox{\hyperlink{classEmployee}{Employee}} is intilized 
\end{DoxyPrecond}
\begin{DoxyReturn}{Returns}
void 
\end{DoxyReturn}
\begin{DoxyPostcond}{Postcondition}
printes out the ID and years worked at the company if its their anniversary 
\end{DoxyPostcond}
...
\begin{DoxyPrecond}{Precondition}
That \mbox{\hyperlink{classEmployee}{Employee}} is intialized 
\end{DoxyPrecond}
\begin{DoxyReturn}{Returns}
double The total pay of the employee 
\end{DoxyReturn}
\begin{DoxyPostcond}{Postcondition}
The pay is calculated and returned 
\end{DoxyPostcond}
...
\end{DoxyReturn}
\begin{DoxyPostcond}{Postcondition}
Prints the information for \mbox{\hyperlink{classEmployee}{Employee}} 
\end{DoxyPostcond}
