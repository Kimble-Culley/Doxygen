 ...
 * @date 2024-04-19
 * @brief the main.cpp driver 
 * 
 * Test all the constructors for the classes Supervisor, Officer, and Employee.
 * Along with testing the individual functionality like calcuatePay, print, and aniversary. 
 */
